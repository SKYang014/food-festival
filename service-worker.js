...
//Why don't we use window.addEventListener instead of self? Well, service 
//workers run before the window object has even been created. So instead we 
...
self.addEventListener('install', function (e) {
    ...
    // before terminating the service worker. This ensures that the service 
    //worker doesn't move on from the installing phase until it's finished 
    //executing all of its code.
